    ...
    return (
      <div className="cart-item">
        <div className="left-block">
          <img alt=""
            style={{ height: 110, width: 100, borderRadius: 30,
             background: '#ccc' }}
            src={product.img}
          />
        </div>
        <div className="right-block">
          <div style={{ textAlign:"left",fontSize: 25 }}> {title} </div>
          <div style={{textAlign:"left", color: '#777' }}>{price}</div>
          <div style={{ textAlign:"left",color: '#777' }}>Qty: {qty}</div>
